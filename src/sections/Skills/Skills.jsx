      ...
      <div className="skills-div">
        ...
        <div className="skills-display">
          ...
          <div className={toolHover || yolkHover ? "initial-icons icons-hidden hidden" : "initial-icons hidden"} id="front-end" ref={addToSkillRefs}>
            ...
            <div className="icon-div">
            <img src="/images/ant-design.png" alt="Ant-design_icon" />
            <p className="icon-title">Ant Design</p>
            </div>
          ...
          <div className={toolHover ? "skills-icons icons-reveal hidden": "skills-icons icons-hidden hidden"} id="tools" ref={addToSkillRefs}>
            ...
            <div className="icon-div">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postman/postman-original.svg" alt="postman_icon" />
            <p className="icon-title">Postman</p>
            </div>

            <div className="icon-div">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg" alt="github_icon" />
